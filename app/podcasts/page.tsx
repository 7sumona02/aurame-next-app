...
const Page = () => {
  return (
    <div className='flex flex-col items-center justify-center px-10 bg-blue-100 LandingImg'>
        <div className='text-5xl font-bold w-screen border-b-2 border-neutral-300 text-center p-8 glassmorphism2'>Podcasts</div>
        <Link href='/'>
